...
- **Data Type**: AUDIO
  *Description: A user’s voice such as a voicemail or a sound recording.*
  - `androidApp/src/main/kotlin/com/iqbalwork/robithoh/MainActivity.kt (Pattern: record)`
- `androidApp/src/main/kotlin/com/iqbalwork/robithoh/review/InAppReviewManager.kt (Pattern: record)`
- **Data Type**: APP_INTERACTIONS
  *Description: Information about how a user interacts with the app. For example, the number of times they visit a page or sections they tap on.*
  - `androidApp/src/main/kotlin/com/iqbalwork/robithoh/MainActivity.kt (Pattern: logEvent)`
- `shared/src/androidMain/kotlin/com/iqbalwork/robithoh/core/analytics/AnalyticsTracker.android.kt (Pattern: logEvent)`
- `shared/src/commonMain/kotlin/com/iqbalwork/robithoh/core/analytics/AnalyticsTracker.kt (Pattern: logEvent)`
- **Data Type**: APPS_ON_DEVICE
  *Description: Information about the apps installed on a user's device.*
  - `shared/src/androidMain/kotlin/com/iqbalwork/robithoh/AppVersion.android.kt (Pattern: getPackageInfo)`
...
Save final JSON output to `/home/iqbalf/Projects/Robithoh/Robithoh App/.scratch/play_policy_insights_05ed3084-5f22-4bdd-bdbc-c8a023467be9/worker_data_safety_part_2.json`.
