...
- **Data Type**: MUSIC
  *Description: A user’s music files.*
  - `shared/src/androidMain/kotlin/com/iqbalwork/robithoh/core/audio/AudioDownloader.android.kt (Pattern: track)`
- `shared/src/androidMain/kotlin/com/iqbalwork/robithoh/core/audio/KmpAudioPlayer.android.kt (Pattern: MediaPlayer)`
- `shared/src/androidMain/kotlin/com/iqbalwork/robithoh/core/notification/PrayerAdzanService.kt (Pattern: MediaPlayer)`
- **Data Type**: FILES_AND_DOCS
  *Description: A user’s files or documents, or information about their files or documents such as file names.*
  - `shared/src/androidMain/kotlin/com/iqbalwork/robithoh/core/designsystem/ShareAction.android.kt (Pattern: text/plain)`
- **Data Type**: HEALTH
  *Description: Information about a user's health, such as medical records or symptoms.*
  - `shared/src/androidMain/kotlin/com/iqbalwork/robithoh/core/sensor/CompassSensor.android.kt (Pattern: SensorManager)`
- **Data Type**: PERFORMANCE_DIAGNOSTICS
  *Description: Information about the performance of your app. For example battery life, loading time, latency, framerate, or any technical diagnostics.*
  - `shared/src/androidMain/kotlin/com/iqbalwork/robithoh/core/notification/PrayerAdzanService.kt (Pattern: PowerManager)`
...
Save final JSON output to `/home/iqbalf/Projects/Robithoh/Robithoh App/.scratch/play_policy_insights_05ed3084-5f22-4bdd-bdbc-c8a023467be9/worker_data_safety_part_3.json`.
